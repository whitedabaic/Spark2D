...
using WindowPtr = std::unique_ptr<SDL_Window, SPARK_UTIL::SDL_Destroyer>;
using SoundFxPtr = std::unique_ptr<Mix_Chunk, SPARK_UTIL::SDL_Destroyer>;
using MusicPtr = std::unique_ptr<Mix_Music, SPARK_UTIL::SDL_Destroyer>;
