...
countEnt:add_component(TextComponent("fangsong", "Balls:", Color(255,255,255,255),4,-1.0))

local valEnt = Entity("","")
valEnt:add_component(Transform(vec2(352,32), vec2(1,1), 0))
local valText = valEnt:add_component(TextComponent("fangsong", "0", Color(255,255,255,255),4,-1.0))
