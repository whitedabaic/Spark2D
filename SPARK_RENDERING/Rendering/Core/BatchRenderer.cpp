...
namespace SPARK_RENDERING {
	...
	void BatchRenderer::Initialize()
	{
		...
		// Position
		glVertexAttribPointer(0, 2, GL_FLOAT, GL_FALSE, sizeof(SPARK_RENDERING::Vertex), (void*)offsetof(SPARK_RENDERING::Vertex, position));
		glEnableVertexAttribArray(0);

		// UVs
		glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, sizeof(SPARK_RENDERING::Vertex), (void*)offsetof(SPARK_RENDERING::Vertex, uvs));
		glEnableVertexAttribArray(1);

		// Color
		glVertexAttribPointer(2, 4, GL_UNSIGNED_BYTE, GL_TRUE, sizeof(SPARK_RENDERING::Vertex), (void*)offsetof(SPARK_RENDERING::Vertex, color));
	...
	void BatchRenderer::AddSprite(const glm::vec4& spriteRect, const glm::vec4 uvRect, GLuint textureID, 
		int layer, glm::mat4 model, const Color& color)
	{
